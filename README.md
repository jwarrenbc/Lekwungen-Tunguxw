# K̓ʷə́nəxʷ Lək̓ʷaŋən Təŋəxʷ (Seeing Lekwungen Land)
...
If you find this data valuable, please [copy it](https://github.com/jwarrenbc/Lekwungen-Tunguxw/archive/refs/heads/main.zip) to help preserve it for future generations. Source code to display the map is licensed by the GNU Affero General Public License. Data is licensed by Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License.
